...
class WebScraperSource(DataSource):
    ...
    def _fetch_page(self, path: str) -> str:
        ...
        try:
            ...
            raise NotImplementedError("Install 'requests' to use WebScraperSource: pip install requests")
    ...
    def _parse_html(self, html: str) -> Any:
        ...
        try:
            ...
            raise NotImplementedError("Install 'beautifulsoup4' to use WebScraperSource: pip install beautifulsoup4")
