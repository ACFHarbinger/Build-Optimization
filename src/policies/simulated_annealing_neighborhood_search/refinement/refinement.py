...
from policies.simulated_annealing_neighborhood_search.search.deterministic import local_search_2
from policies.simulated_annealing_neighborhood_search.search.reversed import local_search_reversed
