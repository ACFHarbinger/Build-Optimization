...
class PolicyFactory:
    ...
    def ensure_registered(cls) -> None:
        ...
        if cls._registered:
            return
        import policies.neural_agent as neural_agent  # noqa
        ...
        import policies.adapters.policy_sisr as policy_sisr  # noqa
        import policies.adapters.policy_hvpl as policy_hvpl  # noqa
        import policies.adapters.policy_ahvpl as policy_ahvpl  # noqa
        import policies.adapters.policy_qde as policy_qde  # noqa
        import policies.adapters.policy_psoma as policy_psoma  # noqa
        import policies.adapters.policy_abc as policy_abc  # noqa
        import policies.adapters.policy_fa as policy_fa  # noqa
        import policies.adapters.policy_sca as policy_sca  # noqa
        import policies.adapters.policy_hs as policy_hs  # noqa
        import policies.adapters.policy_slc as policy_slc  # noqa
        import policies.adapters.policy_lca as policy_lca  # noqa
        import policies.adapters.policy_gphh as policy_gphh  # noqa
        import policies.adapters.policy_hmm_gd as policy_hmm_gd  # noqa
        import policies.adapters.policy_lahc as policy_lahc  # noqa
        import policies.adapters.policy_rrt as policy_rrt  # noqa
        import policies.adapters.policy_oba as policy_oba  # noqa
        import policies.adapters.policy_gls as policy_gls  # noqa
        import policies.adapters.policy_rts as policy_rts  # noqa
        import policies.adapters.policy_ga as policy_ga  # noqa
        import policies.adapters.policy_sa as policy_sa  # noqa
        import policies.adapters.policy_ils as policy_ils  # noqa
        import policies.adapters.policy_vns as policy_vns  # noqa
