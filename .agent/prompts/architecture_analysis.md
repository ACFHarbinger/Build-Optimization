...
3. Confirm which layer owns the change (`backend/`, `middleware/`, `app/`, `extension/`) using [`AGENTS.md § Module Boundaries`](../AGENTS.md#3-module-boundaries) before writing code.
